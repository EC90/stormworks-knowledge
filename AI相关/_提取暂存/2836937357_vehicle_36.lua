-- source: steam id 2836937357 / vehicle.xml block#36
...
function onDraw()
	dial(gn("Dial 1 X"),gn("Dial 1 Y"),gn("Dial 1 Radius"),{gn("Dial 1 Min"),values[1],gn("Dial 1 Max")},string.format("%.0f", values[1]) ,{gn("Dial 1 Sector I R"),gn("Dial 1 Sector I G"),gn("Dial 1 Sector I B"),gn("Dial 1 Sector I Start (0-1)"),gn("Dial 1 Sector I End (0-1)")},{gn("Dial 1 Sector II R"),gn("Dial 1 Sector II G"),gn("Dial 1 Sector II B"),gn("Dial 1 Sector II Start (0-1)"),gn("Dial 1 Sector II End (0-1)")},{gn("Dial 1 Text R"),gn("Dial 1 Text G"),gn("Dial 1 Text B"),100})
	dial(gn("Dial 2 X"),gn("Dial 2 Y"),gn("Dial 2 Radius"),{gn("Dial 2 Min"),values[2],gn("Dial 2 Max")},string.format("%.0f", values[2]),{gn("Dial 2 Sector I R"),gn("Dial 2 Sector I G"),gn("Dial 2 Sector I B"),gn("Dial 2 Sector I Start (0-1)"),gn("Dial 2 Sector I End (0-1)")},{gn("Dial 2 Sector II R"),gn("Dial 2 Sector II G"),gn("Dial 2 Sector II B"),gn("Dial 2 Sector II Start (0-1)"),gn("Dial 2 Sector II End (0-1)")},{gn("Dial 2 Text R"),gn("Dial 2 Text G"),gn("Dial 2 Text B"),100})
