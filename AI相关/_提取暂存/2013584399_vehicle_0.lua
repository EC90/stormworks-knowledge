-- source: steam id 2013584399 / vehicle.xml block#0
...
function onDraw()
	...
	screen.setColor(50, 150, 50, 255)
	screen.drawRectF(w/2 -7, h/2 -3, 16, 8)
--ALT backgrownd color	
	
	screen.setColor(0, 0, 0, 255)
--ALT color	
	screen.drawRect(w/2 -8, h/2 -4, 17, 8)
	screen.drawTextBox(w/2 -6, h/2 -2, 25, 7, string.format("%03.0f", I_ALT), -1, -1)
