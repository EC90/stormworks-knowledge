-- source: steam id 2823494546 / vehicle.xml block#12
...
re()t=1
TE=""q=0
function onTick()W,H,X,Y,t,R,G,B,A,KP,kp=gN(1,2,3,4,7,8,9,10,11,12,13)iP=I.getBool(1)V=pc==1 SD=W*H==15360
if W*H==46080 then ss=13 else ss=7 end
if iP then pc=pc+1 else pc=0 end
if not SD then AR=iR(57,22,174,116)end
...
function onDraw()w=S.getWidth()h=S.getHeight()cw=w/2 ch=h/2 sd=w*h==15360 b=1.8125
for i=1,#l do
...
cp(2)if sd then
dF(0,9,32,h)dF(128,9,38,h)dF(0,9,w,6)dF(0,79,w,17)else
dF(0,9,57,h)dF(0,9,w,13)dF(231,9,57,h)dF(0,138,w,22)end
if not sd then
