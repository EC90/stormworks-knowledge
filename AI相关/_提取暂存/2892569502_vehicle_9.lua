-- source: steam id 2892569502 / vehicle.xml block#9
...
drop=input.getNumber(6)*360-input.getNumber(7)*360-input.getNumber(8)*90
if cps<0 then
dir=-cps*360
else
dir=360-cps*360
...
return 0.0605+1.19*10^(-3)*dist+2.41*10^(-7)*dist^2 end
function onDraw()
screen.setColor(15,233,15)
--screen.drawLine(10,2,w-10,2)
...
screen.drawRectF(w/2-16,9,42,5)
screen.setColor(15,233,15)
screen.drawTextBox(w/2-8,1,16,7,math.floor(dir),0,0)
screen.drawText(w/2+7,9,0.1*math.floor(10*z))
if issub then
screen.drawText(w/2-15,9,'2ndw')
else
screen.drawText(w/2-15,9,'Main')
end
if isIR then
