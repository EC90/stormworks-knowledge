-- source: steam id 3457601476 / vehicle.xml block#15
...
btnsS={
	...
	{false,	'p',	'- '},--17 page3r-
	{false,	'p',	' +'},--18 page3r+
	{false,	't',	'rtb'},--19 page3rtb
	{false,	't',	'cv'},--20 page3cv
...
function onTick()
	...
	--new btn sys touch
	touch=input.getBool(1) and not btnsS[24][1]
	btnt=touch and not toucho
	tx=GN(3)
	ty=GN(4)
	gpsx=GN(5)
	gpsy=GN(6)
	if GN(7)>0 then btnsS[24][1]=false end
	cur=GN(8)
	sID=GN(9)
