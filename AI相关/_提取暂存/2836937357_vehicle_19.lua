-- source: steam id 2836937357 / vehicle.xml block#19
...
function onDraw()
    ...
    DST(2, 20, "ILS AUTOLAND")
    screen.setColor(0, 255, 0)
    DST(0,27,"--ATL WAYPOINTS---")
    screen.setColor(255, 255, 255)
    
if WP1 == true then
     DST(0,37,"SORWP Inputted")
end
if WP2 == true then
     DST(0,45,"EORWP Inputted")
end
if WP1==true and WP2 == true then
     screen.setColor(0, 255, 0)
     DST(4,55,"AUTOLAND AVAIL")
end
