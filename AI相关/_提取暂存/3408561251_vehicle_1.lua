-- source: steam id 3408561251 / vehicle.xml block#1
-- url: https://steamcommunity.com/sharedfiles/filedetails/?id=3408561251
GN=input.getNumber
GB=input.getBool
SN=output.setNumber
SB=output.setBool
...
function onTick()
	...
	if GN(13)~=0 and GN(14)~=0 and abs(GN(21)-GN(22))<1 and (dis(add(wtPos,mux({GN(15),GN(16),GN(17)},-1)))<pN("judge distance") or dis({GN(15),GN(16),GN(17)})<1) then
