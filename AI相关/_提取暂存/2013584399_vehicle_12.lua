-- source: steam id 2013584399 / vehicle.xml block#12
...
function onDraw()
	...
	mask = property.getText("Format")
	text = string.format(mask, value)
    ...
    screen.setColor(property.getNumber("BGR"),
					property.getNumber("BGG"),
					property.getNumber("BGB"), 
					property.getNumber("BGA"))
	screen.drawRectF(x-1,y-1,32,7)
	screen.setColor(property.getNumber("Red [0..255]"),
					property.getNumber("Green [0..255]"),
					property.getNumber("Blue [0..255]"), 
					property.getNumber("Alpha [0..255]"))
