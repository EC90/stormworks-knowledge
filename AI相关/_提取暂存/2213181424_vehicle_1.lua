-- source: steam id 2213181424 / vehicle.xml block#1
...
function onDraw()
	...
	screen.setColor(25, 10, 0)
	screen.drawTriangleF(xA, yA, xB, yB, 250*cos(roll+pi13) + 14, 250*sin(roll+pi13) + c)
	screen.drawTriangleF(xB, yB, 250*cos(roll+pi23) + 16, 250*sin(roll+pi23) + c, 250*cos(roll+pi13) + 14, 250*sin(roll+pi13) + c)
	screen.setColor(255, 255, 255, 200)
	screen.drawLine(r*cos(roll-0.004) + 12 , r*sin(roll-0.004) + c, -r*cos(roll+0.004) + 12, -r*sin(roll+0.004) + c)
	if pitch > -0.96 and pitch < 0.96 then
