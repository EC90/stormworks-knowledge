-- source: steam id 3464467373 / vehicle.xml block#2
...
--bigblue
DA(Ax,Ay,10,-45,135,6,6,6)
DA(Cx,Cy,10,0,135,6,6,6)
--bigred
DA(Ax,Ay,10,135,180,8,8,8)
DA(Cx,Cy,10,135,225,8,8,8)
DA(Bx,By,10,0,180,6,6,6)
DA(Bx,By,8,-10,60,6,6,6)
DA(Bx,By,8,120,190,6,6,6)
DA(Bx,By,8,60,80,8,8,8)
DA(Bx,By,8,100,120,8,8,8)
DS(Ax,Ay,10,-45,135,1,6,6,6)
DS(Ax,Ay,10,135,180,1,8,8,8)
DS(Cx,Cy,10,0,135,1,6,6,6)
DS(Cx,Cy,10,135,225,1,8,8,8)
SC(2,2,2)
DFuel(wh-3,20)
DTemp(wh+1,20)
end
