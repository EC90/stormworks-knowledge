-- source: steam id 2855051802 / microcontroller.xml block#3
...
function onTick()aB=k(4)aG=k(8)w=k(12)O=k(16)ao=k(20)an=k(24)S=k(28)aC=R(11)ax=at("Enable Radar Tracking")T=H("HUD Orientation 2 (Arrow Direction)")v=H("Blocks From Front Of Seat")aF=at("Radar Orientation")M=H("Minimum Radar Distance")av=H("Radar Distance Units")J=R(12)Y=au("Color Value")ae=(H("Brightness")+.5)/1.5
