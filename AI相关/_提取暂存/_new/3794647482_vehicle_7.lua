-- source: steam id 3794647482 / vehicle.xml block#7
...
local pitch_rad=asin(math.max(-1.0,math.min(1.0,2*(w*x-y*z))))
...
Color(60,20,10)
s.drawTriangleF(x1,y1+offset,x2,y2+offset,x3,y3+offset)
s.drawTriangleF(x2,y2+offset,x3,y3+offset,x4,y4+offset)
end
if SS then
Color(R,G,B)
for i=0,4,1 do
...
s.drawCircle(cx,cy+offset,5)
s.drawRectF(cx-1,cy+offset-1,3,3)
Line(cx,cy+offset,cx-sx/6*-cx,cy+offset+sz/6*-cy)
else
s.drawCircle(cx-nV[2]*1.5*cx,cy+offset+nV[1]*1.5*-cy,2)
s.drawCircle(cx,cy+offset,2)
...
if CL then
Color(0,0,0,150)
s.drawRectF(cx-9,0,17,8)
Color(R,G,B)
Text(cx-7,2,flr(com))
s.drawRect(cx-9,0,17,8)
end
if SL then
Color(0,0,0,150)
s.drawRectF(0,cy-4+offset,m.clamp(spddig*5+2,22,9999),8)
Color(R,G,B)
Line(m.clamp(spddig*5+2,22,9999),cy+offset,cx-4,cy+offset)
Text(2,(h/2)-2+offset,spdF)
s.drawRect(0,cy-4+offset,m.clamp(spddig*5+2,22,9999),8)
else
Line(0,cy+offset,cx-4,cy+offset)
end
if AL then
Color(0,0,0,150)
s.drawRectF(w-m.clamp(altdig*5+3,23,9999),cy-4+offset,m.clamp(altdig*5+2,22,9999),8)
Color(R,G,B)
Line(cx+5,cy+offset,w-m.clamp(altdig*5+2,22,9999),cy+offset)
Text(w-m.clamp(altdig*5+1,21,9999),(h/2)-2+offset,altF)
s.drawRect(w-m.clamp(altdig*5+3,23,9999),cy-4+offset,m.clamp(altdig*5+2,22,9999),8)
else
