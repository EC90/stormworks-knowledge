-- source: steam id 3750251471 / vehicle.xml block#2
...
function onDraw()
	...
	screen.setMapColorOcean(12,12,12)
	screen.setMapColorShallows(30,30,30)
	screen.setMapColorLand(78,78,78)
	screen.setMapColorGrass(40,40,40)
	screen.setMapColorSand(90,90,90)
	screen.setMapColorSnow(90,97,90)
