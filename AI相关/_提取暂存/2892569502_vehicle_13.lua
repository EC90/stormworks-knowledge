-- source: steam id 2892569502 / vehicle.xml block#13
...
Dist = 0
function onTick()
sps,fue,bat,ent,rps,gear,fum=igN(22),igN(23),igN(24),igN(21),igN(25),igN(19),igN(20)
park,rev,mode = igB(15),igB(11),igB(16)
sph=sps*3.6
Dist=Dist+sps/60000
