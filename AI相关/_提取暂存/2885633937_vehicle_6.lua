-- source: steam id 2885633937 / vehicle.xml block#6
...
function onTick()
	fue,bat,ent,gea,fum=igN(6),igN(7),igN(8),igN(16),igN(17)
	park,ltdr,ltL,ltR,ltsp,ltem,ltfg= igB(9),igB(20),igB(21),igB(22),igB(29),igB(30),igB(31)
	drS,drF,drB=igB(20),igB(3),igB(4)
aent=ent/110
afue=fue/fum
