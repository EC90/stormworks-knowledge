-- source: steam id 2078172280 / microcontroller.xml block#0
-- url: https://steamcommunity.com/sharedfiles/filedetails/?id=2078172280
...
Mode = 1
	if Time>10 then Mode = 1
	end
	if Time<=10 and Time>0 then Mode = 2
	end
