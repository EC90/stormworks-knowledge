-- source: steam id 3167674961 / vehicle.xml block#58
...
function onTick()
	...
	for i = 8, 1, -1 do
		if input.getBool(i) then
            output.setNumber(1,input.getNumber(2+((i-1)*4))*sensitivity)
            output.setNumber(2,input.getNumber(3+((i-1)*4))*sensitivity)
