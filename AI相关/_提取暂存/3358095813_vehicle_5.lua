-- source: steam id 3358095813 / vehicle.xml block#5
...
btn={
	{1,1,18,9,true,'t','cps'},
	{1,11,18,9,true,'t','wpn'},
	{1,21,18,9,false,'t','D L'},
	{1,31,18,9,false,'t','A R'},
	{1,41,18,9,false,'t','AE1'},
	{1,51,18,9,false,'t','AE2'}}
function db(n)
	if btn[n] then
		local tb=btn[n]
