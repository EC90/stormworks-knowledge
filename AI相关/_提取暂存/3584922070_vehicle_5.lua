-- source: steam id 3584922070 / vehicle.xml block#5
...
fuel,air=enginectrl(rps,rpswhell,abs(thr),pressure,clamp((0.9-chg)*50,0,30),spd)
...
rpst=clamp(throttle*9.5+5,5,mrps)+clamp(rpse,0,mrps)

pidrps[1]=rps
pidrps,a=pid(pidrps,rpst,{0.2,0.002,0})
a=a+rpst*0.047
