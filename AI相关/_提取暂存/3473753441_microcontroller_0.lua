-- source: steam id 3473753441 / microcontroller.xml block#0
...
function onTick()
	...
	output.setNumber(1,Mr[1])
	output.setNumber(2,Mr[4])
	output.setNumber(3,Mr[7])
	output.setNumber(4,Mr[2])
	output.setNumber(5,Mr[5])
	output.setNumber(6,Mr[8])
	output.setNumber(7,Mr[3])
	output.setNumber(8,Mr[6])
	output.setNumber(9,Mr[9])
end
